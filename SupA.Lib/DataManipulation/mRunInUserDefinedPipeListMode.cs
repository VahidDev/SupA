    ...
    public class mRunInUserDefinedPipeListMode
    {
        ...
        public static void RunInUserDefinedPipeListMode()
        {
            ...
            if (mSubInitializationSupA.pubThreeDModelSoftware == "P3D")
            {
                ...
                CollExistingSteel = mImportCSVFiletoColl<cSteel>.ImportCSVFiletoColl(mSubInitializationSupA.pubstrFolderPath + "3DOutSupAIn\\SuptPointSelMode\\", "Area-ExistingSteelData", ".csv", ",", typeof(cSteel), "cSteel");

                CollPipeforSupporting = mImportCSVFiletoColl<cTubeDef>.ImportCSVFiletoColl(mSubInitializationSupA.pubstrFolderPath + "3DOutSupAIn\\SuptPointSelMode\\", "Area-PipeData", ".csv", ",", typeof(cTubeDef), "cTubeDef");
            ...
            for (int I = 1; I <= CollPipeforSupporting.Count; I++)
            {
                ...
                CollExistingSteel = mImportCSVFiletoColl<cSteel>.ImportCSVFiletoColl(mSubInitializationSupA.pubstrFolderPath + "3DOutSupAIn\\SuptPointSelMode\\", "Area-ExistingSteelData-" + I, ".csv", ",", typeof(cSteel), "cSteel");
                ...
                CollExistingConcrete = mImportCSVFiletoColl<cSteel>.ImportCSVFiletoColl(mSubInitializationSupA.pubstrFolderPath + "3DOutSupAIn\\SuptPointSelMode\\", "Area-ExistingConcreteData-" + I, ".csv", ",", typeof(cSteel), "cSteel");
